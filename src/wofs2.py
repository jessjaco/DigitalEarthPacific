...
from utils import scale_to_int16, write_to_blob_storage, raster_bounds, mosaic_scenes
...
class Wofs(Processor):
    def process_by_scene(year: int, output_prefix: str) -> None:
